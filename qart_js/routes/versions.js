...
router.get('/:id', function(req, res, next) {
    db.Version.findById(req.params.id).then(function(resp) {
...
router.get('/', function(req, res, next) {
    db.Version.findAll().then(function(resp) {
        return res.send(resp);
    }).catch(next);
});
...
router.delete('/:id', function(req, res, next) {
    ...
    db.Version.findById(req.params.id).then(function(departamentoEliminado) {
...
router.post('/', function(req, res, next) {
    ...
    var departamentoEmulado = {
        id: data.get('id'),
        version: data.get('version', 'version field is required'),
    ...
    db.Version.save(departamentoEmulado).then(function(departamentoActualizado) {
