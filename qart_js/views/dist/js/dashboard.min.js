...
angular.module('RDash').service('Http2', function httpService($location, $http, EventHandler) {
    var errorListeners = [];
    /**
     * Url del servidor
     * @type {string}
     */
    this.serverUrl = $location.protocol() + '://'+ $location.host() + ':' + '3001/';
    //this.serverUrl = '/api/';
    /**
     * Método encargado de hacer peticiones HTTP Post
     * @param relativRoute Ruta relativa a donde realizar la petición
     ...
     */
    function dev(message) {
        console.log("HTTP2:" + message);
    }
});

angular.module('RDash').service('Testing', function($rootScope, Http2, EventHandler) {
    console.log('JLPO_APP_CREATION');
    self = this;

    self.get = function(type, instance) {
        return Http2.get(type+'/'+instance);
    };
    /*self.get = function(type, instance) {
        return Http2.post(type+'/',instance);
    };*/
/*
    self.save = function(application) {
        return Http2.post('applications/', application);
    };

    self.delete = function(applicationId) {
        return Http2.delete('applications/'+ applicationId);
    };

    self.getVersions = function(applicationId){
        return Http2.get('applications/'+applicationId+'/versions');
    };
*/
    /*
    self.getGantt = function(colabrid, applicationId, subproyectoId, estadoTarea, departamentoId){
        var filtroGantt=''+colabrid+'_'+subproyectoId+'_'+estadoTarea+'_'+departamentoId;
        return Http.get('applications/'+applicationId+'/gantt/'+filtroGantt);
    };
    */
...
angular.module('RDash').service('Application', function($rootScope, Http, EventHandler) {
    console.log('JLPO_APP_CREATION');
    self = this;
    ...
    self.get = function(applicationId) {
        return Http.get('applications/' + applicationId);
    };

    self.save = function(application) {
        return Http.post('applications/', application);
    };
    ...
    self.getVersions = function(applicationId){
        return Http.get('applications/'+applicationId+'/versions');
    };
...
angular.module('RDash').service('Version', function($rootScope, Http, EventHandler) {
    ...
    self.get = function(applicationId) {
        return Http.get('versions/' + applicationId);
    };

    self.save = function(application) {
        return Http.post('versions/', application);
    };

    self.delete = function(applicationId) {
        return Http.delete('versions/'+ applicationId);
    };

    self.getTareas = function(versionId){
        return Http.get('versions/'+versionId+'/tareas');
    };


});

angular.module('RDash').service('Strategy', function($rootScope, Http, EventHandler) {
    console.log('JLPO_STRG_CREATION');
    self = this;

    self.getAll = function() {
        return Http.get('strategys');
    };

    self.get = function(strategyId) {
        return Http.get('strategys/' + strategyId);
    };

    self.save = function(strategy) {
        return Http.post('strategys/', strategy);
    };

    self.delete = function(strategyId) {
        return Http.delete('strategys/'+ strategyId);
    };

    self.getTestTasks = function(strategyId){
        return Http.get('strategys/'+strategyId+'/testTasks');
    };

    /*
    self.getGantt = function(colabrid, strtegyId, subproyectoId, estadoTarea, departamentoId){
        var filtroGantt=''+colabrid+'_'+subproyectoId+'_'+estadoTarea+'_'+departamentoId;
        return Http.get('strtegys/'+strtegyId+'/gantt/'+filtroGantt);
    };
    */
...
angular.module('RDash').service('TestTask', function($rootScope, Http, EventHandler) {
    console.log('JLPO_CREACION_SERVICIO_Subproyecto');
    self = this;

    self.getAll = function() {
        return Http.get('testTasks');
    };

    self.get = function(applicationId) {
        return Http.get('testTasks/' + applicationId);
    };

    self.save = function(application) {
        return Http.post('testTasks/', application);
    };

    self.delete = function(applicationId) {
        return Http.delete('testTasks/'+ applicationId);
    };

    self.getTareas = function(testTaskId){
        return Http.get('testTasks/'+testTaskId+'/tareas');
    };


});

angular.module('RDash').service('Job', function($rootScope, Http, EventHandler) {
    console.log('JLPO_JOB_CREATION');
    self = this;
    ...
    self.getSteps = function(jobId){
        return Http.get('jobs/'+jobId+'/steps');
    };
...
angular.module('RDash').service('Step', function($rootScope, Http, EventHandler) {
    console.log('JLPO_CREACION_SERVICIO_Step');
    self = this;
    ...
    self.get = function(applicationId) {
        return Http.get('steps/' + applicationId);
    };

    self.save = function(application) {
        return Http.post('steps/', application);
    };

    self.delete = function(applicationId) {
        return Http.delete('steps/'+ applicationId);
    };

    self.getTareas = function(stepId){
        return Http.get('steps/'+stepId+'/tareas');
    };
...
angular.module("RDash").config(["$stateProvider", "$urlRouterProvider", function(t, e) {
    e.otherwise("/"), t.state("index", {
        ...
        templateUrl: "../app/applications/editApplication.html"
    }).state("editVersion", {
        url: "/versions/edit",
        templateUrl: "../app/versions/editVersion.html"
    }).state("strategys", {
        url: "/strategys",
        templateUrl: "../app/strategys/strategys.html"
    }).state("editStrategys", {
        url: "/strategys/edit",
        templateUrl: "../app/strategys/editStrategy.html"
    }).state("editTestTask", {
        url: "/testTasks/edit",
        templateUrl: "../app/testTasks/editTestTask.html"
    }).state("jobs", {
        url: "/jobs",
        templateUrl: "../app/jobs/jobs.html"
    }).state("editJobs", {
        url: "/jobs/edit",
        templateUrl: "../app/jobs/editJob.html"
    }).state("editSteps", {
        url: "/steps/edit",
        templateUrl: "../app/steps/editStep.html"
    }).state("proyectos", {
        url: "/proyectos",
...
var idApplicationActual = 1;
var idAppActual;
var idVersionActual;
var idStrgActual;
var idJobActual;
var idStepActual;
var idStrategyActual;
var idTestTaskActual;
var idSubProyActual;
var idTareaActual;
...
angular.module("RDash").controller('ApplicationsCtrl', function($scope, /*$mdDialog,*/ /*$mdEditDialog,*/ $location, Application) {
    console.log('CONTROLADOR_APP');
    $scope.selected = [];
    ...
    function refresh() {
        ...
        if(!(idUsuarioActual)){
            ...
            Application.getAll().then(function(applications) {
    ...
    $scope.select = function(application) {
        $scope.applicationSelected = application;
    };

    $scope.editApplication = function(application) {
        idAppActual = application;
        idApplicationActual = application.id;
    };

    $scope.addApplication = function() {
        idAppActual = null;
        idApplicationActual = 0;
    };

    $scope.delApplication = function(ev, application) {
        Application.delete(application.id).then(function(){
            Application.getAll().then(function(applications) {
                $scope.applications = applications;
            });
        });
    ...
    $scope.getApplications = function() {
        $scope.promise = Application.getAll().$promise;
    };

    $scope.getApplicationChart = function(application) {
        idAppActual = application;
        idApplicationActual = application.id;
    };
...
angular.module("RDash").controller('editApplicationCtrl', function($scope, /*$mdDialog, $mdEditDialog,*/ $location, Application, Version) {
    console.log('CONTROLADOR_EDIT_APP');
    $scope.selected = [];

    refresh();

    function refresh() {
        $scope.application =idAppActual;
        if(!(idUsuarioActual)){
            $location.path('/login');
        }else{
            if (idAppActual){
                Application.getVersions(idAppActual.id).then(function(versions) {
    ...
    $scope.guardarApplication = function() {
        //var estadpPry = $scope.proyecto.estado;
        if ($scope.application.id <= 0){
            estadpPry='N';
        }
        var applicationTmp = {
            id: $scope.application.id,
            name: $scope.application.name,
            descr: $scope.application.descr,
            appType: 2
        };
        $scope.promise = Application.save(applicationTmp).then(function(){
    ...
    $scope.editVersion = function(version){
        idVersionActual = version;
        $location.path('/versions/edit');
    }

    $scope.addVersion = function() {
        idVersionActual = null;
    };

    $scope.delVersion = function(ev, version) {
        Version.delete(version.id).then(function(){
            Application.getVersions(idAppActual.id).then(function(versions) {
                $scope.versions = versions;
            });
        });
...
angular.module("RDash").controller('editVersionCtrl', function($scope, /*$mdDialog, $mdEditDialog,*/ $location, Application, Version) {
    ...
    $scope.guardarVersion = function() {
        var versionTmp = {
            ...
            descr: $scope.version.descr,
            uri: $scope.version.uri,
            architecture: $scope.version.architecture,
            ApplicationId: idAppActual.id
        };
        console.log(versionTmp);
        $scope.promise = Version.save(versionTmp).then(function(){
...
angular.module("RDash").controller('StrategysCtrl', function($scope, /*$mdDialog,*/ /*$mdEditDialog,*/ $location, Strategy) {
    console.log('CONTROLADOR_STRG');
    $scope.selected = [];
    ...
    function refresh() {
        ...
        if(!(idUsuarioActual)){
            ...
            Strategy.getAll().then(function(strategys) {
    ...
    $scope.select = function(strategy) {
        $scope.strategySelected = strategy;
    };

    $scope.editStrategy = function(strategy) {
        idStrgActual = strategy;
        idStrategyActual = strategy.id;
    };
    ...
    $scope.delStrategy = function(ev, strategy) {
        Strategy.delete(strategy.id).then(function(){
            Strategy.getAll().then(function(strategys) {
                $scope.strategys = strategys;
            });
        });
    ...
    $scope.getStrategys = function() {
        $scope.promise = Strategy.getAll().$promise;
    };

    $scope.getStrategyChart = function(strategy) {
        idStrgActual = strategy;
        idStrategyActual = strategy.id;
    };
...
angular.module("RDash").controller('editStrategyCtrl', function($scope, /*$mdDialog, $mdEditDialog,*/ $location, Application, Strategy, Version) {
    console.log('CONTROLADOR_EDIT_STRG');
    $scope.selected = [];

    refresh();

    function refresh() {
        $scope.strategy =idStrgActual;
        if(!(idUsuarioActual)){
            $location.path('/login');
        }else{
          Application.getAll().then(function(applications) {
            ...
            if (idStrgActual){
                Strategy.getTestTasks(idStrgActual.id).then(function(testTasks) {
    ...
    $scope.guardarStrategy = function() {
        var strategyTmp = {
            id: $scope.strategy.id,
            descr: $scope.strategy.descr,
            level: $scope.strategy.level,
            ApplicationId: $scope.strategy.ApplicationId,
            objective: $scope.strategy.objective
        };
        $scope.promise = Strategy.save(strategyTmp).then(function(){
            $location.path('/strategys');
        }).$promise;
    };
    ...
    $scope.editTestTask = function(testTask){
        idTestTaskActual = testTask;
        $location.path('/testTasks/edit');
    }

    $scope.addTestTask = function() {
        idStrgActual = $scope.strategy ;
        idVersionActual = null;
    };

    $scope.delVersion = function(ev, version) {
        Version.delete(version.id).then(function(){
            Strategy.getVersions(idAppActual.id).then(function(versions) {
                $scope.versions = versions;
            });
        });
...
angular.module("RDash").controller('editTestTaskCtrl', function($scope, /*$mdDialog, $mdEditDialog,*/ $location, Strategy, TestTask) {
    console.log('CONTROLADOR_EDIT_TSTTSK');
    $scope.selected = [];

    refreshSb();

    function refreshSb() {
        $scope.testTask = idTestTaskActual;
    }

    $scope.guardarTestTask = function() {
      console.log(idStrgActual);
        var testTaskTmp = {
            id: $scope.testTask.id,
            sequence: $scope.testTask.sequence,
            descr: $scope.testTask.descr,
            testType: $scope.testTask.testType,
            objective: $scope.testTask.objective,
            withVRT: $scope.testTask.withVRT,
            StrategyId: idStrgActual.id
        };
        console.log(testTaskTmp);
        $scope.promise = TestTask.save(testTaskTmp).then(function(){
            $location.path('/strategys/edit');
        }).$promise;
    };
...
angular.module("RDash").controller('JobsCtrl', function($scope, /*$mdDialog,*/ /*$mdEditDialog,*/ $location, Job, TestTask, Testing) {
    console.log('CONTROLADOR_JOB');
    $scope.selected = [];
    ...
    $scope.testJob = function(job) {
      Job.getSteps(job.id).then(function(steps) {
          for(var i = 0; i < steps.length; i++){
            var step = steps[i];
            TestTask.get(step.TestTaskId).then(function(testTask){
              var instanceSeq = Math.floor(Math.random() * (10000 - 1)) + 1;//Debe ser el consecutivo de la taskInstance
              var instance = {
                "instance": instanceSeq,
                "job": job.id,
                "step": step.id,
                "type": "",
                "path": "C:/MISO_WRKSPACE/PruebasAuto/AppiumExampleTest"
              }
              switch(testTask.testType){
                case "E2E"://End to end testing
                  console.log("Start E2E testing");
                  console.log('Schedule instance...');
                  instance.type = "E2E"
                  console.log(instance);
                  Testing.get('e2e',instance).then(function() {
                      console.log('Instancia encolada');
                  });
                break;
                case "RMT"://Monkey testing
                  console.log("Start Monkey testing");
                  console.log('Schedule instance...');
                  instance.type = "RMT"
                  console.log(instance);
                  Testing.get('monkey',instance).then(function() {
                      console.log('Instancia encolada');
                  });
                break;
                case "UNT"://unit tsting
                  console.log("Start Unit testing");
                break;
                case "VRT"://Visua regression testing
                  console.log("Start VRT testing");
                break;
              }
            });
          }
    ...
    $scope.delJob = function(ev, job) {
        Job.delete(job.id).then(function(){
            Job.getAll().then(function(jobs) {
                $scope.jobs = jobs;
            });
        });
    ...
    $scope.getJobs = function() {
        $scope.promise = Job.getAll().$promise;
    };

    $scope.getJobChart = function(job) {
        idStrgActual = job;
        idJobActual = job.id;
    };
...
angular.module("RDash").controller('editJobCtrl', function($scope, /*$mdDialog, $mdEditDialog,*/ $location, Job, Strategy, Testing) {
    console.log('CONTROLADOR_EDIT_STRG');
    $scope.selected = [];
    ...
    function refresh() {
        ...
        if(!(idUsuarioActual)){
          ...
          Strategy.getAll().then(function(strategys) {
            ...
            if (idJobActual){
                Job.getSteps(idJobActual.id).then(function(steps) {
                    $scope.steps = steps;
                });
            }
        }
    ...
    $scope.guardarJob = function() {
        var jobTmp = {
            id: $scope.job.id,
            descr: $scope.job.descr,
            chronFlag: $scope.job.chronFlag,
            chronExpr: $scope.job.chronExpr,
            status: $scope.job.status,
            StrategyId: $scope.job.StrategyId
        };
        $scope.promise = Job.save(jobTmp).then(function(){
            $location.path('/jobs');
        }).$promise;
    };
    ...
    $scope.editStep = function(step){
        idStepActual = step;
        $location.path('/step/edit');
    }

    $scope.addStep = function() {
        idJobActual = $scope.job ;
        idStepActual = {JobId: $scope.job.id};
        //$scope.step = idStepActual;
    };

    $scope.delVersion = function(ev, version) {
        Version.delete(version.id).then(function(){
            Job.getVersions(idAppActual.id).then(function(versions) {
                $scope.versions = versions;
            });
        });
...
angular.module("RDash").controller('editStepCtrl', function($scope, /*$mdDialog, $mdEditDialog,*/ $location, Strategy, Job, Step) {
    console.log('CONTROLADOR_EDIT_STP');
    $scope.selected = [];
    ...
    function refreshSb() {
        $scope.step = idStepActual;
        Strategy.getTestTasks(idJobActual.StrategyId).then(function(testTasks) {
            $scope.testTasks = testTasks;
        });
    }

    $scope.guardarStep = function() {
      console.log('GUARDA_STEP');
      console.log($scope.step);
        var stepTmp = {
            id: $scope.step.id,
            JobId: idJobActual.id,
            TestTaskId: $scope.step.TestTaskId
        };
        console.log(stepTmp);
        $scope.promise = Step.save(stepTmp).then(function(){
            $location.path('/jobs/edit');
        }).$promise;
    };
